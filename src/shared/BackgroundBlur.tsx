...
const BackgroundBlur = () => {
  return (
    ...
    <div className="fixed inset-0 z-[-1] pointer-events-none w-full h-full">
      <div className="absolute -top-[20%] -left-[10%] w-[50vw] h-[50vh] sm:h-[15vw] rounded-full bg-[#FFB226] blur-[15vw] opacity-70"></div>
      <div className="absolute -top-[20%] -right-[10%] w-[50vw] h-[50vh] sm:h-[15vw] rounded-full bg-[#307AFD] blur-[15vw] opacity-70"></div>
