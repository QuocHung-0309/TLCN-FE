...
import { Plus, Edit2, Trash2, Globe, Lock, MessageSquare, MapPin, Calendar, ImageIcon, X } from "lucide-react";
      ...
      {editingItem && (
        ...
        >
          <div
            ...
            className="bg-white rounded-2xl shadow-2xl shadow-slate-900/15 border border-slate-100 max-w-md w-full overflow-hidden"
          >
            <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
              <h3 className="text-[16px] font-bold text-slate-800">Sửa kỷ niệm</h3>
              <button
                onClick={() => setEditingItem(null)}
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3.5 py-2.5 border border-slate-200 rounded-xl focus:ring-2 focus:ring-orange-400 focus:border-orange-400 outline-none resize-none transition"
                />
              </div>
              <div>
            ...
            <div className="flex gap-2.5 px-6 pb-6">
              <button
                onClick={() => setEditingItem(null)}
                className="flex-1 py-2.5 border border-slate-200 bg-white text-slate-600 font-bold rounded-xl hover:bg-slate-50 transition-colors"
              >
                Hủy
              </button>
              <button
                ...
                disabled={savingEdit}
                className="flex-1 py-2.5 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white font-bold rounded-xl shadow-lg shadow-orange-500/25 active:scale-[0.98] disabled:opacity-50 transition"
              >
