...
const BlogCardFeatured: React.FC<BlogFeaturedProps> = ({
  slug,
  title,
  excerpt,
  image,
  ...
  return (
    <article className="group relative overflow-hidden rounded-2xl ring-1 ring-black/5 shadow hover:shadow-lg transition h-full">
      ...
      <div className="absolute inset-x-0 bottom-0 p-4 sm:p-5">
        <h3 className="text-white font-extrabold text-lg sm:text-xl uppercase leading-tight line-clamp-2">
          {title}
        </h3>
